/* Copied C:\Program Files\Common Files\MSVC\freeglut\bin\x64\freeglut.dll to C:\Windows */
#include<Windows.h>    
// first include Windows.h header file which is required    
#include<stdio.h>    
#include<gl/GL.h>   // GL.h header file    
#include<gl/GLU.h> // GLU.h header file    
#include "C:\Program Files\Common Files\MSVC\freeglut\include\GL\glut.h" // glut.h header file from freeglut\include\GL folder    
#include<conio.h>    
#include<stdio.h>    
#include<math.h>    
#include<string.h>    
